...
def train():
    ...
    # use peft
    if collie_args.peft_type is not None:
        print(f'Using peft.{collie_args.peft_type}')
        if collie_args.peft_type == 'lora':
            ...
            raise ValueError(f"Unknown PEFT type: {collie_args.peft_type}")
